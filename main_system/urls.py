...
urlpatterns = [
    ...
    # path('<int:year>/<int:month>/<int:day>/<slug:provider>/<int:offer_id>/', views.take_room_offer,
    #     name='take_room_offer'),
    # path('remove_room_offer/<int:offer_id>/', views.remove_room_offer, name='remove_room_offer'),
